...
if {$shared != 0} {
    send_user "There is one LUN mapped to each server, but it\n"
    send_user "is the same LUN.  The test requirement\n"
    send_user "is to map two different LUNs to each OVS server.\n"
