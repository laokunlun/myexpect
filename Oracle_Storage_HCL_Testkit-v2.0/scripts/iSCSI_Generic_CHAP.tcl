...
set CHAP_Password [lindex $argv 2]
...
if {[verifyConfigData "chap" $configData] == "False"} {
...
set CHAP_UserName [dict get $configData "CHAP_UserName"]
...
## Logging
append logfile $LOGDIR "iSCSI_CHAP_Generic_Plugin_Certification.log"
set testStep 0
...
set testStatus(GSIS-201,status) "Not Run"
set testStatus(GSIS-202,status) "Not Run"
set testStatus(GSIS-203,status) "Not Run"
set testStatus(GSIS-204,status) "Not Run"
...
#################################################################
##
##       Test Suite 1: iSCSI over CHAP with Generic Plugin
##
#################################################################
...
## Testcase GSIS-101
set testStatus(GSIS-201,status) "Failed"
send_user "\nHCL> At this time, the iSCSI tests with CHAP enabled will be executed.\n"
send_user "     Please ensure that your environment is configured correctly for\n"
send_user "     CHAP Authentication, then when you are ready to begin, press\n"
send_user "     Enter to resume: "
gets stdin data
printTestHeader "GSIS-101" "Discover OVM servers."
source iSCSI_Generic_CHAP-setup.tcl
...
gets stdin data
printTestHeader "GSIS-201" "Discover LUNs -- CHAP Authentication."
source $PWD/scripts/Generic_CHAP-map.tcl
set testStatus(GSIS-201,status) "Passed"


## Testcase GSIS-202
set testStatus(GSIS-202,status) "Failed"
...
send_user "     After the LUNs have been resized, press Enter to resume: "
gets stdin data
printTestHeader "GSIS-202" "Resize LUNs -- CHAP Authentication"
source $PWD/scripts/Generic_CHAP-resize.tcl
set testStatus(GSIS-202,status) "Passed"


## Testcase GSIS-203
set testStatus(GSIS-203,status) "Failed"
send_user "\nHCL> At this time, please unmap the two LUNs from the previous step.\n"
send_user "     After the LUNs have been unmapped, press Enter to resume: "
gets stdin data
printTestHeader "GSIS-203" "Unmap LUNs -- CHAP Authentication"
source $PWD/scripts/Generic_CHAP-unmap.tcl
set testStatus(GSIS-203,status) "Passed"


## Testcase GSIS-204
set testStatus(GSIS-204,status) "Failed"
printTestHeader "GSIS-204" "Deleting the iSCSI Storage Array -- CHAP Authentication"
source $PWD/scripts/Generic_CHAP-teardown.tcl
set testStatus(GSIS-204,status) "Passed"
...
source $PWD/scripts/Generic-iscsi-chap-setup.tcl
