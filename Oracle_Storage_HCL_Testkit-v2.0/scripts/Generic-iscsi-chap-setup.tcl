...
send "create StorageArray name='$SAN_ServerName' plugin=\"$myPluginID\" storageType=ISCSI accessHost=$SAN_AccessHost accessPort=$SAN_AccessPort useChap=yes accessUsername=$CHAP_UserName accessPassword=$CHAP_Password \r"
